        ...
        <div className="container">
          {/* HEADER */}
              <header className="app-header">
                      <h1 className="app-title">LyricsVideo AI</h1>h1>
                      <p className="app-subtitle">MP3를 업로드하면 곡을 자동 인식하고 가사를 검색합니다</p>p>
              </header>header>
        
          {/* 1. UPLOAD */}
              <div className="section-card">
                      <p className="section-title">01 &nbsp;·&nbsp; MP3 업로드</p>p>
                      <div
                        ...
                        {audioFile ? (
                                              <>
                                                            ...
                                                            <p className="file-name">{audioFile.name}</p>p>
                                                            <p>클릭하여 파일 변경</p>p>
                                              </>>
                                            ) : (
                                              <>
                                                            <div className="upload-icon">☁️</div>div>
                                                            <p>MP3 파일을 드래그하거나 클릭하여 선택</p>p>
                                              </>>
                                            )}
                      </div>div>
                      <input
          ...
          {/* 2. EDIT */}
              <div className="section-card">
                      <p className="section-title">02 &nbsp;·&nbsp; 프로젝트 편집</p>p>
                      <div className="form-row">
                                <div className="form-group">
                                            <label>곡 제목</label>label>
                                            <input
                                                            value={project.title}
                                ...
                                <div className="form-group">
                                            <label>아티스트</label>label>
                                            <input
                                                            value={project.artist}
                                                            onChange={(e) => setProject((p) => ({ ...p, artist: e.target.value }))}
                                                            placeholder="아티스트명"
                                                          />
                                </div>div>
                      </div>div>
                      <div className="form-group">
                                <label>가사 (각 줄 = 한 화면에 표시될 라인)</label>label>
                                <textarea
                                              value={project.lyrics}
                                              onChange={(e) => setProject((p) => ({ ...p, lyrics: e.target.value }))}
                                              placeholder="가사를 입력하세요. 각 줄이 하나의 가사 라인으로 싱크됩니다."
                                            />
                      </div>div>
          ...
          {/* 3. STYLE */}
              <div className="section-card">
                      <p className="section-title">03 &nbsp;·&nbsp; 영상 스타일</p>p>
                      <div className="style-controls">
                                <div className="form-group">
                                            <label>배경 색상</label>label>
                                            <div className="color-input-wrap">
                                                          <input
                                                                            ...
                                                                            onChange={(e) =>
                                                                                                setProject((p) => ({
                                                                                                                      ...p,
                                                                                                                      videoSettings: { ...settings, backgroundColor: e.target.value },
                                                                                                  }))
                                                                            }
                                                                          />
                                                          <input
                                            ...
                                            <div className="color-input-wrap">
                                                          <input
                                                                            ...
                                                                            onChange={(e) =>
                                                                                                setProject((p) => ({
                                                                                                                      ...p,
                                                                                                                      videoSettings: { ...settings, textColor: e.target.value },
                                                                                                  }))
                                                                            }
                                                                          />
                                                          <input
                                ...
                                <div className="form-group">
                                            <label>글씨 크기</label>label>
                                            <div className="range-wrap">
                                                          <div className="range-label">
                                                                          <span style={{ fontSize: "0.8rem", color: "var(--text-muted)" }}>크기</span>span>
                                                                          <span className="range-value">{settings.fontSize}px</span>span>
                                                          </div>div>
                                                          <input
                                                                            type="range"
                                                                            min={32}
                                                                            ...
                                                                            onChange={(e) =>
                                                                                                setProject((p) => ({
                                                                                                                      ...p,
                                                                                                                      videoSettings: { ...settings, fontSize: Number(e.target.value) },
                                                                                                  }))
                                                                            }
                                                                          />
                                            </div>div>
                      ...
                      <div className="preview-area" style={{ marginTop: 16 }}>
                                <div
                                            ...
                                            >
                                            <span
                                                            className="preview-lyrics-text"
                                                            style={{ color: settings.textColor, fontSize: Math.round(settings.fontSize * 0.45) }}
                                                          >
                                              {displayLine}
                                            </span>span>
                                </div>div>
          ...
          {lyricsLines.length > 0 && (
                  <div className="section-card">
                            <p className="section-title">04 &nbsp;·&nbsp; 가사 싱크 설정</p>p>
                            <p style={{ fontSize: "0.82rem", color: "var(--text-muted)", marginBottom: 14 }}>
                                        음악 재생 중 각 라인의 [싱크] 버튼을 눌러 타이밍을 설정하세요
                            </p>p>
                            <div className="sync-list">
                              {lyricsLines.map((line, idx) => (
                                  <div key={idx} className={`sync-item${idx === currentLine ? " active" : ""}`}>
                                                  ...
                                                  <span className="sync-text">{line.text}</span>span>
                                                  <button className="sync-btn" onClick={() => setSyncTime(idx)}>
                                                                    싱크
                                                  </button>button>
                                  </div>div>
                                ))}
          ...
          {/* 5. SAVE/LOAD */}
              <div className="section-card">
                      <p className="section-title">05 &nbsp;·&nbsp; 저장 / 불러오기</p>p>
                      <div className="save-load-row">
                                <input
                                              ...
                                              placeholder="프로젝트 ID"
                                            />
                                <button className="btn btn-primary btn-sm" onClick={handleSave}>저장</button>button>
                                <button className="btn btn-secondary btn-sm" onClick={handleLoad}>불러오기</button>button>
                                <button className="btn btn-secondary btn-sm" onClick={handleRefreshList}>목록</button>button>
                      </div>div>
                    ...
                    <div className="project-list">
                      {savedProjects.map((p, i) => (
                                    <div
                                                    ...
                                                    >
                                                    <div>
                                                                      <div className="project-item-title">{p.title || "제목 없음"}</div>div>
                                                                      <div className="project-item-meta">{p.artist}</div>div>
                                                    </div>div>
                                    </div>div>
                                  ))}
                    </div>div>
